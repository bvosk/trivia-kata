...
public class GoldenMasterMockScenario
{
...
public static class GoldenMasterMockScenarios
{
    public static IEnumerable<GoldenMasterMockScenario> Scenarios { get; set; } = new[]
    {
        new GoldenMasterMockScenario
        {
            SeedValue = 2,
            ExpectedOutput = """
                             Chet was added
